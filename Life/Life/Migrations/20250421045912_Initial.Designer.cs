...
namespace Life.Migrations
{
    ...
    [Migration("20250421045912_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Life.Life.Shared.Entities.Exercise", b =>
                {
            ...
            modelBuilder.Entity("Life.Life.Shared.Entities.Food", b =>
                {
            ...
            modelBuilder.Entity("Life.Life.Shared.Entities.FoodNutrient", b =>
                {
                    b.Property<int>("FoodId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Life.Life.Shared.Entities.Location", b =>
                {
            ...
            modelBuilder.Entity("Life.Life.Shared.Entities.Meal", b =>
                {
            ...
            modelBuilder.Entity("Life.Life.Shared.Entities.MealLog", b =>
                {
            ...
            modelBuilder.Entity("Life.Life.Shared.Entities.Member", b =>
                {
                    b.Property<int>("MemberId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Life.Life.Shared.Entities.Nutrient", b =>
                {
                    b.Property<int>("NutrientId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Life.Life.Shared.Entities.Personal", b =>
                {
                    b.Property<int>("PersonalId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Life.Life.Shared.Entities.ProgressMeasurement", b =>
                {
            ...
            modelBuilder.Entity("Life.Life.Shared.Entities.Team", b =>
                {
                    b.Property<int>("TeamId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Life.Life.Shared.Entities.Workout", b =>
                {
                    b.Property<int>("WorkoutId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Life.Life.Shared.Entities.WorkoutExercise", b =>
                {
                    b.Property<int>("WorkoutId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Life.Life.Shared.Entities.WorkoutLog", b =>
                {
            ...
            modelBuilder.Entity("Life.Life.Shared.Entities.FoodNutrient", b =>
                {
                    b.HasOne("Life.Life.Shared.Entities.Food", "Food")
                        .WithMany("NutrientDetails")
                        .HasForeignKey("FoodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Life.Life.Shared.Entities.Nutrient", "Nutrient")
                        .WithMany()
            ...
            modelBuilder.Entity("Life.Life.Shared.Entities.MealLog", b =>
                {
                    b.HasOne("Life.Life.Shared.Entities.Meal", "Meal")
                        .WithMany()
                        .HasForeignKey("MealId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Life.Life.Shared.Entities.Member", "Member")
                        .WithMany("MealLogs")
            ...
            modelBuilder.Entity("Life.Life.Shared.Entities.Member", b =>
                {
                    ...
                    b.HasOne("Life.Life.Shared.Entities.Personal", "Personal")
                        .WithMany("Members")
                        .HasForeignKey("PersonalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Life.Life.Shared.Entities.Team", "Team")
                        .WithMany("Members")
                        .HasForeignKey("TeamId");

                    b.HasOne("Life.Life.Shared.Entities.Workout", "Workout")
                        .WithMany()
            ...
            modelBuilder.Entity("Life.Life.Shared.Entities.Team", b =>
                {
                    b.HasOne("Life.Life.Shared.Entities.Location", "Location")
                        .WithMany("Teams")
            ...
            modelBuilder.Entity("Life.Life.Shared.Entities.WorkoutExercise", b =>
                {
                    b.HasOne("Life.Life.Shared.Entities.Exercise", "Exercise")
                        .WithMany()
